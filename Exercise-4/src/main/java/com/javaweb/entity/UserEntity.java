...
public class UserEntity extends BaseEntity {
    ...
    private List<CustomerEntity> assignedCustomers = new ArrayList<>();
    ...
    // 🌟 GETTER/SETTER MỚI
    public List<CustomerEntity> getAssignedCustomers() {
        return assignedCustomers;
    }

    public void setAssignedCustomers(List<CustomerEntity> assignedCustomers) {
